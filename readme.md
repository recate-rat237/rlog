...
fn main() {
    let mut msg_strct = Vec::<MsgStructElement>::default();
    msg_strct.push(MsgStructElement::DateAndTime);
    
    msg_strct.push(MsgStructElement::Message);
    
    msg_strct.push(MsgStructElement::Mark);
    //let log_g = RLogger::new(msg_struct, 1_i32); // fast ?
    let log_g = RLogger::new(msg_strct, 1);
